...
; hotkey, ifWinActive,% ( ClassImgglass[1] || ClassImgglass[2] )
; hotkey, WheelLeft,  ImgGlassScroll_R
; hotkey, ifWinActive,% ( ClassImgglass[1] || ClassImgglass[2] )
; hotkey, WheelDown,  ImgGlassScroll_R
; hotkey, ifWinActive,% ( ClassImgglass[1] || ClassImgglass[2] )
; hotkey, WheelUp,    ImgGlassScroll_L
; hotkey, ifWinActive,% ( ClassImgglass[1] || ClassImgglass[2] )
; hotkey, WheelRight, ImgGlassScroll_L
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	~^#c::
	setTimer, HandlerCopyinfo, -1
	handlercopied:=true
	setTimer, Handle_Handler_Toggle, -15000
	return,
#if handlercopied
	~^v::
	handlercopied:=false
	setTimer, Handle_Handler_Toggle, -666
	return,
#if
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
^#Mbutton::            ;  CTRL + WIN + MIDDLE=MOUSE-BUTT
Handle_Handler_Toggle: ;  TOGGLE - INFO - DISPLAY
Handle_Handler_Active := !Handle_Handler_Active 	    

tt("klklklk")
if Handle_Handler_Active {
	menu, submenu1, check, Handle Handler,
	setTimer, handler_Tip_refresh, 100
	setTimer, handler_Tip_kill,   -33300
	;Handle_Handler_Active := True
	return,	
} else {	
	menu, submenu1, uncheck, Handle Handler,
	sleep 100
	setTimer, handler_Tip_refresh, off
	setTimer, tooltipdestroy,     -1750 
	;Handle_Handler_Active := false
}
handlercopied:=false
return,
...
tt( ("Translucency:`n" Transparent "`nTransColor:`t " TransColor))
return,
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
if ( X_Cursor <  A_ScreenWidth  *.5 )
	 TTX :=   (  A_ScreenWidth  *.5 ) + 100
else TTX :=   (  A_ScreenWidth  *.5 ) - 400
if ( Y_Cursor <  A_ScreenHeight *.5 )
	 TTY :=   (  A_ScreenHeight *.5 ) + 100
else TTY :=   (  A_ScreenHeight *.5 ) - 300
...
if ( WindowUnderCursorInfo   != WindowUnderCursorInfoOld )	{	;fixes flicker
	tooltip %WindowUnderCursorInfo%, %TTX% , %TTY%, 3
	WindowUnderCursorInfoOld := WindowUnderCursorInfo
}

if (A_TimeIdle > 60000)
	settimer, Handle_Handler_Toggle, -1
...
menu,         SubMenu1, add,%    "Pen CPL", pen_cpl
...
menu, SubMenu1, icon, Cursor FX, C:\Icon\24\Star_of_David_Purple.ico
;-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=
menu, tray, standard
...
pen_cpl:
aa="C:\Windows\system32\rundll32.exe" Shell32.dll,Control_RunDLL "C:\Windows\System32\TabletPC.cpl"
run,% aa
return,
;---------------------------------------------------------------------------------------
